...
class Migration(migrations.Migration):
    dependencies = [("netbox_openbao", "0016_engine_journey_permissions")]
    ...
    operations = [
        migrations.AlterModelOptions(
            ...
            options={
                "ordering": ("name",),
                "permissions": OPENBAO_CLUSTER_PERMISSIONS
                + (
                    ...
                    (
                        ...
                        "Manage OpenBao Kubernetes secrets-engine configuration",
                    ),
                    (
                        "delete_k8s_configuration",
                        "Delete OpenBao Kubernetes secrets-engine configuration",
                    ),
